...
class GlossaryEnergy(GlossaryWitnessCore):
    ...
    TechnoNextFullDict = {
        DepletedOilGas: True,
        BiomassBuryingFossilization: False,
        Reforestation: True,
        UnmanagedWood: True,
        EnhancedOilRecovery: True,
        CarbonStorageTechno: True,
        BiomassFermentation: True,
        GeologicMineralization: True,
        DeepOceanInjection: False,
        PureCarbonSolidStorage: False,
        DeepSalineFormation: True,
        AnaerobicDigestion: True,
        BiomassFired: True,
        Nuclear: True,
        CropEnergy: True,
        ElectrolysisPEM: True,
        OilGen: True,
        ManagedWood: True,
        SolarPv: True,
        SolarThermal: False,
        WindOffshore: True,
        CombinedCycleGasTurbine: True,
        WindOnshore: True,
        CoalGen: True,
        BiogasFired: True,
        GasTurbine: True,
        Geothermal: True,
        HefaDeoxygenation: True,
        Hydropower: True,
        HeatPumpHighHeat: False,
        GeothermalHighHeat: False,
        CHPHighHeat: False,
        NaturalGasBoilerHighHeat: False,
        WaterGasShift: True,
        ElectricBoilerHighHeat: False,
        Refinery: True,
        HeatPumpLowHeat: False,
        HydrogenLiquefaction: False,
        CHPLowHeat: False,
        GeothermalLowHeat: False,
        ElectricBoilerLowHeat: False,
        NaturalGasBoilerLowHeat: False,
        ElectricBoilerMediumHeat: False,
        NaturalGasBoilerMediumHeat: False,
        GeothermalMediumHeat: False,
        FossilGas: True,
        HeatPumpMediumHeat: False,
        Methanation: False,
        CHPMediumHeat: False,
        CO2Hydrogenation: True,
        UpgradingBiogas: True,
        Pelletizing: True,
        PlasmaCracking: False,
        Pyrolysis: True,
        GlossaryWitnessCore.CleanEnergySimpleTechno: True,
        BiomassGasification: True,
        AutothermalReforming: True,
        CoalGasification: True,
        ReversedWaterGasShift: True,
        CoElectrolysis: True,
        SMR: True,
        Transesterification: False,
        FossilSimpleTechno: True,
        HefaDecarboxylation: True,
        CoalExtraction: True,
        FischerTropsch: True,
        ElectrolysisSOEC: True,
        ElectrolysisAWE: True,
        f"{flue_gas_capture}.{ChilledAmmoniaProcess}": False,
        f"{flue_gas_capture}.{CO2Membranes}": False,
        f"{flue_gas_capture}.{FlueGasTechno}": True,
        f"{flue_gas_capture}.{MonoEthanolAmine}": True,
        f"{flue_gas_capture}.{PiperazineProcess}": False,
        f"{flue_gas_capture}.{CalciumLooping}": True,
        f"{flue_gas_capture}.{PressureSwingAdsorption}": False,
        f"{direct_air_capture}.{AmineScrubbing}": True,
        f"{direct_air_capture}.{DirectAirCaptureTechno}": True,
        f"{direct_air_capture}.{CalciumPotassiumScrubbing}": True,
    }

    # After COARSE = {
    #     FossilSimpleTechno, -> oil, gas, coal and fossil_electricity (mix moyen) : tout créer
    #     CleanEnergySimpleTechno, -> RenewableElectricity à créer + Biomass (to burn it)
    #     FlueGas,
    #     Dac,
    #     CarbonStorageTechno,

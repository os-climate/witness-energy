...
class TechnoDiscipline(SoSWrapp):
    ...
    def run(self):
        ...
        outputs_dict = {'techno_detailed_prices': self.techno_model.cost_details,
                        'techno_prices': self.techno_model.cost_details[['years', self.techno_name, f'{self.techno_name}_wotaxes']],

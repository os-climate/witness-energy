...
class CCTechno(TechnoType):
    ...
    def compute_dnon_usecapital_dfluegas(self, dcapex_dfluegas, dprod_dfluegas):
        ...
        dnon_usecapital_dfluegas = dtechnocapital_dfluegas * (
                1.0 - self.applied_ratio['applied_ratio'].values * self.inputs[f'{GlossaryEnergy.UtilisationRatioValue}:{GlossaryEnergy.UtilisationRatioValue}']/ 100.).reshape((len(self.years), 1))

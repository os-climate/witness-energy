    ...
    DESC_IN = {
        ...
        'invest_mix': {'type': 'dataframe',
                       'dataframe_descriptor': {'years': ('int', [1900, 2100], False),
                                                ...
                                                'heat.highheattemperature.NaturalGasBoiler': ('float', None, True),
                                                'heat.highheattemperature.ElectricBoiler': ('float', None, True),
                                                'heat.highheattemperature.HeatPump': ('float', None, True),
                                                'heat.highheattemperature.Geothermal': ('float', None, True),
                                                'heat.lowheattemperature.NaturalGasBoiler': ('float', None, True),
                                                'heat.lowheattemperature.ElectricBoiler': ('float', None, True),
                                                'heat.lowheattemperature.HeatPump': ('float', None, True),
                                                'heat.lowheattemperature.Geothermal': ('float', None, True),
                                                'heat.mediumheattemperature.NaturalGasBoiler': ('float', None, True),
                                                'heat.mediumheattemperature.ElectricBoiler': ('float', None, True),
                                                'heat.mediumheattemperature.HeatPump': ('float', None, True),
                                                'heat.mediumheattemperature.Geothermal': ('float', None, True),

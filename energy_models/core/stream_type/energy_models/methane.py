...
Modifications on 2023/05/04-2024/02/01 Copyright 2024 Capgemini
...
class Methane(EnergyType):
    ...
    emission_name = 'CH4'
    default_techno_list = [GlossaryEnergy.Methanation, GlossaryEnergy.UpgradingBiogas, GlossaryEnergy.FossilGas]

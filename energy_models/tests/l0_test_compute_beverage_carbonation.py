...
class BeverageCarbonationTestCase(unittest.TestCase):
    """
    BeverageCarbonation prices test class
    """
    ...
    def setUp(self):
        ...
        self.energy_carbon_emissions = pd.DataFrame(
            {GlossaryEnergy.Years: years, ResourceGlossary.BeverageCarbonation['name']: 0.0, 'electricity': 0.0, 'methane':0.2})
    ...
    def test_03_beverage_c_discipline(self):
        ...
        inputs_dict = {f'{self.name}.{GlossaryEnergy.YearEnd}': self.year_end,
                       ...
                       BeverageCarbonationDiscipline.invest_before_year_start,

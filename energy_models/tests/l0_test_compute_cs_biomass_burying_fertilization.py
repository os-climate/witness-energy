...
class BiomassBFPriceTestCase(unittest.TestCase):
    ...
    def test_01_compute_biomass_bf_price(self):
        ...
        inputs_dict = {GlossaryCore.YearStart: 2020,
                       ...
                       GlossaryCore.InvestmentBeforeYearStartValue: BiomassBuryingFossilizationDiscipline.invest_before_year_start,
                       ...
                       'initial_production': BiomassBuryingFossilizationDiscipline.initial_storage,
                       'initial_age_distrib': BiomassBuryingFossilizationDiscipline.initial_age_distribution,
        ...
        biomass_bf_model = BiomassBF('BiomassBuryingFossilization')
        biomass_bf_model.configure_parameters(inputs_dict)
        biomass_bf_model.configure_parameters_update(inputs_dict)
        price_details = biomass_bf_model.compute_price()
    ...
    def test_02_compute_biomass_bf_price_prod_consumption(self):
        ...
        biomass_bf_model.compute_consumption_and_production()

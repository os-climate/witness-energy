...
class ChemicalsPriceTestCase(unittest.TestCase):
    """
    Chemicals prices test class
    """
    ...
    def test_01_chemicals_discipline(self):

        self.name = 'Test'
        self.model_name = 'Chemicals'
        ...
        mod_path = 'energy_models.models.carbon_utilization.chemicals.chemicals_disc.ChemicalsDiscipline'

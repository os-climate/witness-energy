...
class CropEnergyPriceTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.stream_prices = pd.DataFrame(
            {GlossaryEnergy.Years: years, GlossaryEnergy.electricity: 90., GlossaryEnergy.carbon_capture: 70.})
        ...
        self.transport = pd.DataFrame(
            {GlossaryEnergy.Years: years, 'transport': 0.1})
    ...
    def test_02_crop_residues_discipline(self):
        ...
        inputs_dict = {f'{self.name}.{GlossaryEnergy.YearEnd}': self.year_end,
                       ...
                       f'{self.name}.{GlossaryEnergy.InvestLevelValue}': self.invest_level,

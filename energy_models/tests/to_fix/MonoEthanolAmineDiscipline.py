...
class MyGeneratedTest(AbstractJacobianUnittest):
    ...
    def test_execute(self):
        with open('data\energy_models_models_carbon_capture_flue_gas_capture_mono_ethanol_amine_mono_ethanol_amine_disc_MonoEthanolAmineDiscipline.pkl', 'rb') as f:
        ...
        self.check_jacobian(location=dirname(__file__), filename='jacobianIsolatedDiscTest_MDO_MDA_CCUS_carbon_capture_flue_gas_capture_MonoEthanolAmine.pkl',

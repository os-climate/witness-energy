...
class FGFlueGasTechnoTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.energy_prices = pd.DataFrame(
            {'years': years, 'renewable': np.ones(len(np.arange(2020, 2051))) * 80.0})
    ...
    def test_01_compute_flue_gas_techno_price(self):
        ...
        inputs_dict = {'year_start': 2020,
                       ...
                       'invest_before_ystart': FlueGasTechnoDiscipline.invest_before_year_start,
                       'margin':  self.margin,
        ...
        plt.plot(price_details['years'], price_details['Flue_gas_capture.FlueGasTechno_factory'],

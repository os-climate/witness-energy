...
class BiomassFermentationPriceTestCase(unittest.TestCase):
    """
    BiomassFermentation prices test class
    """
    ...
    def test_01_compute_biomass_fermentation_price_prod_consumption(self):
        ...
        inputs_dict = {GlossaryCore.YearStart: 2020,
                       ...
                       GlossaryCore.InvestmentBeforeYearStartValue: BiomassFermentationDiscipline.invest_before_year_start,
                       ...
                       'initial_production': BiomassFermentationDiscipline.initial_production,
                       'initial_age_distrib': BiomassFermentationDiscipline.initial_age_distribution,
                       ...
                       'data_fuel_dict': Ethanol.data_energy_dict,
                       }

        bf_model = BiomassFermentation('BiomassFermentation')

...
class PolymersPriceTestCase(unittest.TestCase):
    """
    Polymers prices test class
    """
    ...
    def test_01_polymers_discipline(self):

        self.name = 'Test'
        self.model_name = 'Polymers'
        ...
        mod_path = 'energy_models.models.carbon_utilization.polymers.polymers_disc.PolymersDiscipline'

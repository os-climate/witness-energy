...
from energy_models.models.heat.low.geothermal_low_heat.geothermal_low_heat_disc import GeothermalLowHeatDiscipline
...
class GeothermalHeatLowTemperatureTestCase(unittest.TestCase):
    ...
    def test_01_compute_Geothermal_Heat_price(self):
        ...
        inputs_dict = {GlossaryCore.YearStart: 2020,
                       ...
                       'techno_infos_dict': GeothermalLowHeatDiscipline.techno_infos_dict_default,
                       GlossaryCore.EnergyPricesValue: self.energy_prices,
                       GlossaryCore.ResourcesPriceValue: self.resources_price,
                       GlossaryCore.InvestLevelValue: self.invest_level,
                       GlossaryCore.InvestmentBeforeYearStartValue: GeothermalLowHeatDiscipline.invest_before_year_start,
                       ...
                       'initial_production': GeothermalLowHeatDiscipline.initial_production,
                       'initial_age_distrib': GeothermalLowHeatDiscipline.initial_age_distribution,

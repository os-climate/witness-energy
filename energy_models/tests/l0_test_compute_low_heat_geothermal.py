...
from energy_models.models.heat.low.geothermal.geothermal_disc import GeothermalHeatDiscipline
...
class GeothermalHeatLowTemperatureTestCase(unittest.TestCase):
    ...
    def test_02_GeothermalLow_discipline(self):
        ...
        mod_path = 'energy_models.models.heat.low.geothermal.geothermal_disc.GeothermalHeatDiscipline'

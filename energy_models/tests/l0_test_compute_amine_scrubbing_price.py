...
class AmineScrubbingTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.stream_prices = pd.DataFrame(
            {GlossaryEnergy.Years: years, GlossaryEnergy.electricity: 0.16 * 1000.0, GlossaryEnergy.methane: .16 * 1000.0,
             })

        self.stream_co2_emissions = pd.DataFrame(
            {GlossaryEnergy.Years: years, GlossaryEnergy.AmineResource: 0.0, GlossaryEnergy.electricity: 0.0, GlossaryEnergy.methane: 0.2})
        self.resources_price = pd.DataFrame({GlossaryEnergy.Years: years, GlossaryEnergy.AmineResource: 1300.
                                             })

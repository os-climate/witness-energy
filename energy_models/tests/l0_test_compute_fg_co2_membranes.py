...
class FGCO2MembranesTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.energy_prices = pd.DataFrame(
            {GlossaryEnergy.Years: years, 'electricity': np.ones(len(np.arange(2020, 2051))) * 80.0, 'methane': np.ones(len(np.arange(2020, 2051))) * 80.0})
    ...
    def test_01_compute_co2_membranes_price(self):
        ...
        plt.plot(price_details[GlossaryEnergy.Years], price_details['Flue_gas_capture.CO2Membranes_factory'],

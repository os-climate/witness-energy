...
class DesignVariablesTestCase(unittest.TestCase):
    """
    ...
    def test_01_design_var_discipline(self):
        """
        Test design var discipline
        ...
        inputs_dict = {f'{self.name}.energy_list': self.energy_list,
                       ...
                       f'{self.name}.hydrogen.gaseous_hydrogen_array_prices': self.hydrogen_prices,
                       f'{self.name}.methane.methane_array_prices': self.methane_prices,

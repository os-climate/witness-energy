...
class WindOffshoreTestCase(unittest.TestCase):
    ...
    def test_01_compute_wind_offshore_price(self):
        ...
        inputs_dict = {GlossaryEnergy.YearStart: 2020,
                       ...
                       GlossaryEnergy.InvestmentBeforeYearStartValue: WindOffshoreDiscipline.invest_before_year_start,
        ...
        plt.plot(price_details[GlossaryEnergy.Years], price_details['WindOffshore_factory'],

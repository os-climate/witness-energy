...
class FGCalciumLoopingTestCase(unittest.TestCase):
    ...
    def test_01_compute_calcium_looping_price(self):
        ...
        inputs_dict = {'year_start': 2020,
                       ...
                       'invest_before_ystart': CalciumLoopingDiscipline.invest_before_year_start,
                       'margin':  self.margin,
        ...
        plt.plot(price_details['years'], price_details['Flue_gas_capture.CalciumLooping_factory'],

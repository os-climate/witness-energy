...
class FGPressureSwingAdsorptionTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.energy_prices = pd.DataFrame(
            {GlossaryEnergy.Years: years,
             ...
             'heat.hightemperatureheat': np.ones(len(np.arange(GlossaryEnergy.YeartStartDefault, 2050 + 1))) * 80.0,
        ...
        self.energy_carbon_emissions = pd.DataFrame(
            {GlossaryEnergy.Years: years, GlossaryEnergy.electricity: 0.0, 'heat.hightemperatureheat':  0.0 })
    ...
    def test_01_compute_Pressure_swing_adsorption_price(self):
        ...
        plt.plot(price_details[GlossaryEnergy.Years], price_details['Flue_gas_capture.PressureSwingAdsorption_factory'],

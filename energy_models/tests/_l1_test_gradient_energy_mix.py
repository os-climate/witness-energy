...
#             {'years': self.years, 'biomass_dry': energy_prices_biomass,
...
#
#         inputs_names = [
#             f'{name}.{model_name}.{energy}.energy_prices' for energy in energy_list if
#             energy not in ['carbon_capture', 'carbon_storage']]
#         inputs_names.extend([
#             f'{name}.{model_name}.{energy}.energy_production' for energy in energy_list if
#             energy not in ['carbon_capture', 'carbon_storage']])
#         inputs_names.extend(
#             [f'{name}.{model_name}.{energy}.energy_consumption' for energy in energy_list if
#              energy not in ['carbon_capture', 'carbon_storage']])
#         inputs_names.extend(
...
#         inputs_names.extend(
#             [f'{name}.{model_name}.{energy}.CO2_emissions' for energy in energy_list if
#              energy not in ['carbon_capture', 'carbon_storage']])
#         inputs_names.extend(

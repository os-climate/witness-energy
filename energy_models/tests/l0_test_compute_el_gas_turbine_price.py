...
class GasTurbinePriceTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.biblio_data = self.biblio_data.loc[self.biblio_data['sos_name']
                                                == f'{GlossaryEnergy.electricity}.Gas_Turbine']
    ...
    def test_01_compute_gas_turbine_price(self):
        ...
        inputs_dict = {GlossaryEnergy.YearStart: GlossaryEnergy.YearStartDefault,
                       ...
                       GlossaryEnergy.InvestmentBeforeYearStartValue: GasTurbineDiscipline.invest_before_year_start,
        ...
        plt.plot(price_details[GlossaryEnergy.Years],
                 price_details['GasTurbine'], label='SoSTrades Total')

        plt.plot(price_details[GlossaryEnergy.Years], price_details['transport'],
                 label='SoSTrades Transport')

        plt.plot(price_details[GlossaryEnergy.Years], price_details['GasTurbine_factory'],
    ...
    def test_03_gas_turbine_discipline(self):
        ...
        self.name = 'Test'
        self.model_name = 'GasTurbine_Electricity'

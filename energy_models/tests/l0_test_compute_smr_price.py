...
class SMRPriceTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.margin = pd.DataFrame(
            {'years': np.arange(2020, 2051), 'margin': np.ones(len(np.arange(2020, 2051))) * 110.0})
    ...
    def test_02_compute_smr_price_prod_consumption(self):
    ...
    def test_03_smr_discipline(self):
        ...
        mod_path = 'energy_models.models.gaseous_hydrogen.smr.smr_disc.SMRDiscipline'

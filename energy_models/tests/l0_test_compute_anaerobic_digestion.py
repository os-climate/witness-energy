...
#             graph.to_plotly().show()
    ...
    def test_03_biomass_gas_discipline_analytic_grad(self):
        ...
        succeed = disc_techno.check_jacobian(threshold=5e-5, inputs=[f'{self.name}.{self.model_name}.invest_level',
                                             ...
                                             load_jac_path=join(dirname(__file__), 'jacobian_pkls',
                                                                f'jacobian_biomass_gas_discipline.pkl'))

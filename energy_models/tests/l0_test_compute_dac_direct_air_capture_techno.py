...
class DirectAirCaptureTechnoTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.energy_prices = pd.DataFrame({'years': years, 'renewable': np.array([0.16, 0.15974117039450046, 0.15948672733558984,
        ...
        self.energy_carbon_emissions = pd.DataFrame(
            {'years': years, 'renewable': 0.0, 'methane':0.2})
    ...
    def test_02_compute_direct_air_capture_techno_price_prod_consumption(self):
        ...
        inputs_dict = {'year_start': 2020,
                       ...
                       'margin':  self.margin,
                       'invest_before_ystart': DirectAirCaptureTechnoDiscipline.invest_before_year_start,

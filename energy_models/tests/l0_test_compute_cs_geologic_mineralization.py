...
from energy_models.models.carbon_storage.geologic_mineralization.geologic_mineralization_disc import GeologicMineralizationDiscipline
...
class GeologicMineralizationPriceTestCase(unittest.TestCase):
    """
    Geologic Mineralization prices test class
    """
    ...
    def test_01_compute_geologic_mineralization_price(self):
        ...
        inputs_dict = {GlossaryCore.YearStart: 2020,
                       ...
                       GlossaryCore.InvestmentBeforeYearStartValue: GeologicMineralizationDiscipline.invest_before_year_start,
                       ...
                       'initial_production': GeologicMineralizationDiscipline.initial_storage,
                       'initial_age_distrib': GeologicMineralizationDiscipline.initial_age_distribution,
        ...
        geologic_mineralization_model = GeologicMineralization(
            'GeologicMineralization')
        geologic_mineralization_model.configure_parameters(inputs_dict)
        geologic_mineralization_model.configure_parameters_update(inputs_dict)
        price_details = geologic_mineralization_model.compute_price()
    ...
    def test_02_compute_geologic_mineralization_price_prod_consumption(self):
        ...
        geologic_mineralization_model.compute_consumption_and_production()

...
class FlueGasRatioTestCase(unittest.TestCase):
    ...
    def test_01_fluegas_discipline(self):
        ...
        ns_dict = {
                   # 'ns_flue_gas': f'{self.name}.{self.model_name}',
                   'ns_direct_air': f'{self.name}.{self.model_name}',
        ...
        mod_path = 'energy_models.core.stream_type.carbon_disciplines.direct_air_disc.DirectAirDiscipline'
        ...
        inputs_dict = {
                       f'{self.name}.{self.model_name}.{GlossaryEnergy.techno_list}': ['carbon_capture.direct_air_capture.AmineScrubbing', 'carbon_capture.direct_air_capture.CalciumPotassiumScrubbing'],
                       f'{self.name}.carbon_capture.direct_air_capture.AmineScrubbing.{GlossaryEnergy.TechnoProductionValue}': self.electricity_CoalGen_production,
                       f'{self.name}.carbon_capture.direct_air_capture.CalciumPotassiumScrubbing.{GlossaryEnergy.TechnoProductionValue}': self.hydrogen_WaterGasShift_production,

...
from energy_models.models.heat.low.chplowheat.chplowheat_disc import CHPLowHeatDiscipline
...
class CHPTestCase(unittest.TestCase):
    ...
    def test_01_compute_chp_price_prod_consumption(self):
        ...
        inputs_dict = {GlossaryCore.YearStart: 2020,
                       ...
                       'techno_infos_dict': CHPLowHeatDiscipline.techno_infos_dict_default,
                       GlossaryCore.EnergyPricesValue: self.energy_prices,
                       GlossaryCore.ResourcesPriceValue: self.resources_price,
                       GlossaryCore.InvestLevelValue: self.invest_level,
                       GlossaryCore.InvestmentBeforeYearStartValue: CHPLowHeatDiscipline.invest_before_year_start,
                       ...
                       'initial_production': CHPLowHeatDiscipline.initial_production,
                       'initial_age_distrib': CHPLowHeatDiscipline.initial_age_distribution,

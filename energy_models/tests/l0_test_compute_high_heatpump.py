...
from energy_models.models.heat.high.heat_pump.heat_pump_disc import HeatPumpDiscipline
...
class HeatPumpHighTemperaureTestCase(unittest.TestCase):
    ...
    def test_02_heatpump_discipline(self):
        ...
        mod_path = 'energy_models.models.heat.high.heat_pump.heat_pump_disc.HeatPumpDiscipline'

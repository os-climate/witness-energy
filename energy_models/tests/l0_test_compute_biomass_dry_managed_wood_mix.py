...
class ManagedWoodPriceTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.invest_level = pd.DataFrame(
            {GlossaryCore.Years: years, GlossaryCore.InvestValue: np.array([1135081003.0, 1135081003.0, 1135081003.0,
    ...
    def test_01_compute_managed_wood_price_prod_consumption(self):
        ...
        inputs_dict = {GlossaryCore.YearStart: 2020,
                       ...
                       GlossaryCore.InvestmentBeforeYearStartValue: ManagedWoodDiscipline.invest_before_year_start,

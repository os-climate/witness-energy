...
from energy_models.models.heat.low.electric_boiler.electric_boiler_disc import ElectricBoilerDiscipline
...
class ElectricBoilerTestCase(unittest.TestCase):
    ...
    def test_02_electric_boiler_discipline(self):
        ...
        mod_path = 'energy_models.models.heat.low.electric_boiler.electric_boiler_disc.ElectricBoilerDiscipline'

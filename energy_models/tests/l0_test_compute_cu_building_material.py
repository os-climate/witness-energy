...
class BuildingMPriceTestCase(unittest.TestCase):
    """
    BuildingM prices test class
    """
    ...
    def test_01_building_m_discipline(self):

        self.name = 'Test'
        self.model_name = 'BuildingMaterial'
        ...
        mod_path = 'energy_models.models.carbon_utilization.building_material.building_material_disc.BuildingMaterialDiscipline'

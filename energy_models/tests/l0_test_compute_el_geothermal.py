...
class GeothermalTestCase(unittest.TestCase):
    ...
    def test_04_compute_geothermal_power(self):
        ...
        print(geothermal_model.production_detailed[f'electricity ({geothermal_model.product_energy_unit})'])

        self.assertLessEqual(list(geothermal_model.production_detailed[f'electricity ({geothermal_model.product_energy_unit})'].values),
        ...
        self.assertGreaterEqual(list(geothermal_model.production_detailed[f'electricity ({geothermal_model.product_energy_unit})'].values),

    ...
    def setup_usecase(self):
        ...
        for energy in self.energy_list:
            ...
            for technology in self.dict_technos[energy]:
                ...
                dv_arrays_dict[f'{mda_usecase.study_name}.{self.energy_mix_name}.{energy}.{technology}.{energy_wo_dot}_{technology_wo_dot}_array_mix'] = dspace_df[
        ...
        for ccs in self.ccs_list:
            ...
            for technology in self.dict_technos[ccs]:
                technology_wo_dot = technology.replace('.', '_')
                dv_arrays_dict[f'{mda_usecase.study_name}.{self.ccs_mix_name}.{ccs}.{technology}.{ccs_wo_dot}_{technology_wo_dot}_array_mix'] = dspace_df[

...
class Study(EnergyMixStudyManager):
    ...
    def get_investments(self):
        ...
        if self.bspline:
            invest_biomass_dry_mix_dict[GlossaryCore.Years] = self.years
    ...
    def setup_usecase(self):
        ...
        self.invest_level = pd.DataFrame(
            {GlossaryCore.Years: years, GlossaryCore.InvestValue: 1e4})

        land_surface_for_food = pd.DataFrame({GlossaryCore.Years: years,
        ...
        values_dict = {f'{self.study_name}.{GlossaryCore.YearStart}': self.year_start,
                       ...
                       f'{self.study_name}.{energy_name}.ManagedWood.{GlossaryCore.MarginValue}': self.margin,
                       f'{self.study_name}.{energy_name}.UnmanagedWood.{GlossaryCore.MarginValue}': self.margin,
                       f'{self.study_name}.{energy_name}.CropEnergy.{GlossaryCore.MarginValue}': self.margin,

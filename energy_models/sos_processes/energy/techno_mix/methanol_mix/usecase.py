...
class Study(EnergyMixStudyManager):
    ...
    def get_investments(self):
        ...
        if self.bspline:
            invest_methanol_mix_dict['years'] = self.years
    ...
    def setup_usecase(self):
        ...
        self.energy_carbon_emissions = pd.DataFrame(
            {'years': years, Electricity.name: 0.0, GaseousHydrogen.name: 0.0, CarbonCapture.name: 0.0})

        self.resources_carbon_emissions = pd.DataFrame({'years': years, Water.name: 0.0})
        ...
        values_dict = {f'{self.study_name}.year_start': self.year_start,
                       ...
                       f'{self.study_name}.{energy_name}..margin': self.margin,

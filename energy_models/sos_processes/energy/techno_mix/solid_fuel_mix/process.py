...
from energy_models.sos_processes.energy.techno_mix.solid_fuel_mix.usecase import TECHNOLOGIES_LIST_FOR_OPT
...
class ProcessBuilder(EnergyProcessBuilder):
    ...
    def get_builders(self):
        ...
        if self.invest_discipline == INVEST_DISCIPLINE_OPTIONS[0]:
            mods_dict_invest = {f'{energy_mix}.{solid_fuel_name}': 'energy_models.core.investments.disciplines.techno_invest_disc.InvestTechnoDiscipline',
                                }

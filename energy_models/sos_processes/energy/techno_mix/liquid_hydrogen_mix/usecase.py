...
class Study(EnergyMixStudyManager):
    ...
    def setup_usecase(self):
        ...
        values_dict = {f'{self.study_name}.{GlossaryEnergy.YearStart}': self.year_start,
                       ...
                       f'{self.study_name}.{lh_name}.HydrogenLiquefaction.{GlossaryEnergy.MarginValue}': self.margin,
                       f'{self.study_name}.{lh_name}.{GlossaryEnergy.TransportCostValue}': self.transport,
                       f'{self.study_name}.{lh_name}.{GlossaryEnergy.TransportMarginValue}': self.margin,
        ...
        if self.main_study:
            ...
            if self.invest_discipline == INVEST_DISCIPLINE_OPTIONS[1]:
                ...
                for techno in self.technologies_list:
                    ...
                    values_dict[f'{self.study_name}.{lh_name}.{techno}.{GlossaryEnergy.InvestLevelValue}'] = invest_level_techno
            else:
                values_dict[f'{self.study_name}.{lh_name}.{GlossaryEnergy.InvestLevelValue}'] = self.invest_level
        else:

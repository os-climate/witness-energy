...
from energy_models.sos_processes.energy.techno_mix.liquid_hydrogen_mix.usecase import TECHNOLOGIES_LIST_FOR_OPT
...
class ProcessBuilder(EnergyProcessBuilder):
    ...
    _ontology_data = {
        'label': 'Energy Technology Mix - Liquid Hydrogen Mix',
        'description': '',
        'category': '',
        'version': '',
    }
    ...
    def get_builders(self):
        ...
        mods_dict = {}
        mods_dict[f'{energy_mix}.{liquid_hydrogen_name}'] = self.get_stream_disc_path(
            'energy_disciplines', 'LiquidHydrogen')

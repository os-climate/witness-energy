...
class ProcessBuilder(EnergyProcessBuilder):
    ...
    def __init__(self, ee):
        ...
        self.techno_list = GlossaryEnergy.DEFAULT_TECHNO_DICT_DEV[GlossaryEnergy.methane]['value']
    ...
    def get_builders(self):
        ...
        mods_dict = {}
        mods_dict[f'{energy_mix}.{methane_name}'] = self.get_stream_disc_path(
            'energy_disciplines', 'Methane')

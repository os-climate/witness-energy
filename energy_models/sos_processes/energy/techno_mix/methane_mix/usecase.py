...
class Study(EnergyMixStudyManager):
    ...
    def setup_usecase(self):
        ...
        values_dict = {f'{self.study_name}.{GlossaryCore.YearStart}': self.year_start,
                       ...
                       f'{self.study_name}.{energy_name}.FossilGas.{GlossaryCore.MarginValue}': self.margin,
                       f'{self.study_name}.{energy_name}.UpgradingBiogas.{GlossaryCore.MarginValue}': self.margin,
                       f'{self.study_name}.{energy_name}.Methanation.{GlossaryCore.MarginValue}': self.margin,

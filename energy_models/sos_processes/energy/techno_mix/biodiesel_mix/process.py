...
class ProcessBuilder(EnergyProcessBuilder):
    ...
    _ontology_data = {
        'label': 'Energy Technology Mix - Biodiesel Mix',
        'description': '',
        'category': '',
        'version': '',
    }
    ...
    def get_builders(self):
        ...
        ns_dict = {'ns_biodiesel': f'{ns_study}.{energy_mix}.{biodiesel_name}',
                   'ns_energy': f'{ns_study}.{energy_mix}',
                   'ns_energy_study': f'{ns_study}',
                   'ns_public': f'{ns_study}',
                   'ns_solid_fuel': f'{ns_study}.{energy_mix}.solid_fuel',
                   'ns_resource': f'{ns_study}.{energy_mix}'}

        mods_dict = {}
        mods_dict[f'{energy_mix}.{biodiesel_name}'] = self.get_stream_disc_path(
        ...
        if self.invest_discipline == INVEST_DISCIPLINE_OPTIONS[0]:
            mods_dict_invest = {f'{energy_mix}.{biodiesel_name}': 'energy_models.core.investments.disciplines.techno_invest_disc.InvestTechnoDiscipline',
                                }

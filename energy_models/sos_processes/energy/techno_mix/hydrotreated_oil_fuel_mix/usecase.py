...
class Study(EnergyMixStudyManager):
    ...
    def setup_usecase(self):
        ...
        self.invest_level = pd.DataFrame(
            {GlossaryEnergy.Years: years, GlossaryEnergy.InvestValue: 350.0 / 1000})
        ...
        values_dict = {f'{self.study_name}.{GlossaryEnergy.YearStart}': self.year_start,
                       ...
                       f'{self.study_name}.{energy_name}.HefaDecarboxylation.{GlossaryEnergy.MarginValue}': self.margin,
                       f'{self.study_name}.{energy_name}.HefaDeoxygenation.{GlossaryEnergy.MarginValue}': self.margin,

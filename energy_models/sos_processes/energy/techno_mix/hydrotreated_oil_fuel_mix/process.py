...
from energy_models.sos_processes.energy.techno_mix.hydrotreated_oil_fuel_mix.usecase import TECHNOLOGIES_LIST_FOR_OPT
...
class ProcessBuilder(EnergyProcessBuilder):
    ...
    def get_builders(self):
        ...
        ns_dict = {'ns_hydrotreated_oil_fuel': f'{ns_study}.{energy_mix}.{energy_name}',
        ...
        mods_dict = {}
        mods_dict[f'{energy_mix}.{energy_name}'] = self.get_stream_disc_path(

...
class ProcessBuilder(EnergyProcessBuilder):
    ...
    def get_builders(self):
        ...
        ns_dict = {'ns_carbon_utilization': f'{ns_study}.{self.prefix_name}.{carbon_utilization_name}',
                   ...
                   'ns_food_products': f'{ns_study}.{self.prefix_name}.{carbon_utilization_name}.{food_products_name}',
                   'ns_fuel_production': f'{ns_study}.{self.prefix_name}.{carbon_utilization_name}.{fuel_production_name}',
        ...
        mods_dict[f'{self.prefix_name}.{carbon_utilization_name}.{food_products_name}'] = 'energy_models.core.stream_type.carbon_disciplines.food_products_disc.FoodProductsDiscipline'
        ...
        #
        mods_dict[
            f'{self.prefix_name}.{carbon_utilization_name}.fuel_production'] = 'energy_models.core.stream_type.carbon_disciplines.fuel_production_disc.FuelProductionDiscipline'

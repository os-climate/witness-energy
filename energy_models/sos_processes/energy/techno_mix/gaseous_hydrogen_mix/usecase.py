...
class Study(EnergyMixStudyManager):
    ...
    def get_investments(self):
        ...
        if self.bspline:
            invest_hydrogen_mix_dict[GlossaryCore.Years] = self.years
    ...
    def setup_usecase(self):
        ...
        values_dict = {f'{self.study_name}.{GlossaryCore.YearStart}': self.year_start,
                       ...
                       f'{self.study_name}.{energy_name}.Electrolysis.PEM.{GlossaryCore.MarginValue}': self.margin,
                       f'{self.study_name}.{energy_name}.Electrolysis.AWE.{GlossaryCore.MarginValue}': self.margin,
                       f'{self.study_name}.{energy_name}.Electrolysis.SOEC.{GlossaryCore.MarginValue}': self.margin,
                       f'{self.study_name}.{energy_name}.PlasmaCracking.{GlossaryCore.MarginValue}': self.margin,
                       f'{self.study_name}.{energy_name}.WaterGasShift.{GlossaryCore.MarginValue}': self.margin,

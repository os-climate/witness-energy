...
from energy_models.sos_processes.energy.techno_mix.electricity_mix.usecase import TECHNOLOGIES_LIST_FOR_OPT
...
class ProcessBuilder(EnergyProcessBuilder):
    ...
    def get_builders(self):
        ...
        if not self.one_invest_discipline:
            ...
            mods_dict_invest = {f'{energy_mix}.{electricity_name}': 'energy_models.core.investments.disciplines.techno_invest_disc.InvestTechnoDiscipline',
                                }

...
class Study(EnergyMixStudyManager):
    ...
    def get_investments(self):
        ...
        if self.bspline:
            ...
            invest_syngas_mix_dict[GlossaryCore.Years] = self.years
    ...
    def setup_usecase(self):
        ...
        values_dict = {f'{self.study_name}.{GlossaryCore.YearStart}': self.year_start,
                       ...
                       f'{self.study_name}.{energy_name}.{GlossaryCore.techno_list}': technologies_list,
                       f'{self.study_name}.{energy_name}.BiomassGasification.{GlossaryCore.MarginValue}': self.margin,
                       f'{self.study_name}.{energy_name}.SMR.{GlossaryCore.MarginValue}': self.margin,
                       f'{self.study_name}.{energy_name}.Pyrolysis.{GlossaryCore.MarginValue}': self.margin,
                       f'{self.study_name}.{energy_name}.CoalGasification.{GlossaryCore.MarginValue}': self.margin,
                       f'{self.study_name}.{energy_name}.AutothermalReforming.{GlossaryCore.MarginValue}': self.margin,
                       f'{self.study_name}.{energy_name}.CoElectrolysis.{GlossaryCore.MarginValue}': self.margin,

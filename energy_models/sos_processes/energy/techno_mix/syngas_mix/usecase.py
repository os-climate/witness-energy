...
class Study(EnergyMixStudyManager):
    ...
    def setup_usecase(self):
        ...
        self.energy_prices = pd.DataFrame({GlossaryEnergy.Years: years, 'electricity': 16.0,
                                           'methane': 80.0,
                                           'biomass_dry': 50.0,
                                           'solid_fuel': 50.0})
        ...
        values_dict = {f'{self.study_name}.{GlossaryEnergy.YearStart}': self.year_start,
                       ...
                       f'{self.study_name}.{energy_name}.BiomassGasification.{GlossaryEnergy.MarginValue}': self.margin,
                       f'{self.study_name}.{energy_name}.SMR.{GlossaryEnergy.MarginValue}': self.margin,
                       f'{self.study_name}.{energy_name}.Pyrolysis.{GlossaryEnergy.MarginValue}': self.margin,
                       f'{self.study_name}.{energy_name}.CoalGasification.{GlossaryEnergy.MarginValue}': self.margin,
                       f'{self.study_name}.{energy_name}.AutothermalReforming.{GlossaryEnergy.MarginValue}': self.margin,
                       f'{self.study_name}.{energy_name}.CoElectrolysis.{GlossaryEnergy.MarginValue}': self.margin,

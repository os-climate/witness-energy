...
class Study(EnergyMixStudyManager):
    def __init__(self, year_start=GlossaryEnergy.YearStartDefault, year_end=GlossaryEnergy.YearEndDefault,
                 technologies_list=GlossaryEnergy.DEFAULT_COARSE_TECHNO_DICT[GlossaryEnergy.fossil]["value"],
    ...
    def setup_usecase(self, study_folder_path=None):
        ...
        values_dict = {f'{self.study_name}.{GlossaryEnergy.YearStart}': self.year_start,
                       ...
                       f'{self.study_name}.{fossil_name}.{GlossaryEnergy.FossilSimpleTechno}.{GlossaryEnergy.MarginValue}': margin,

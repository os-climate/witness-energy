...
from energy_models.sos_processes.energy.techno_mix.biogas_mix.usecase import TECHNOLOGIES_LIST_FOR_OPT
...
class ProcessBuilder(EnergyProcessBuilder):
    ...
    def get_builders(self):
        ...
        mods_dict = {}
        mods_dict[f'{energy_mix}.{biogas_name}'] = self.get_stream_disc_path(
            'energy_disciplines', 'Biogas')
        ...
        if self.invest_discipline == INVEST_DISCIPLINE_OPTIONS[0]:
            mods_dict_invest = {f'{energy_mix}.{biogas_name}': 'energy_models.core.investments.disciplines.techno_invest_disc.InvestTechnoDiscipline',
                                }

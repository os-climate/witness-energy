...
from energy_models.sos_processes.energy.techno_mix.renewable_mix.usecase import TECHNOLOGIES_LIST_FOR_OPT
...
class ProcessBuilder(EnergyProcessBuilder):
    ...
    _ontology_data = {
        'label': 'Energy Technology Mix - Renewable Mix',
        'description': '',
        'category': '',
        'version': '',
    }
    ...
    def get_builders(self):
        ...
        ns_dict = {'ns_renewable': f'{ns_study}.{energy_mix}.{renewable_name}',
        ...
        mods_dict = {}
        mods_dict[f'{energy_mix}.{renewable_name}'] = self.get_stream_disc_path(
            'energy_disciplines', 'Renewable')

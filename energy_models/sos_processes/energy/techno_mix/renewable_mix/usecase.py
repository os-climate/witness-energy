...
TECHNOLOGIES_LIST_FOR_OPT = ['RenewableSimpleTechno']
...
class Study(EnergyMixStudyManager):
    ...
    def setup_usecase(self):
        ...
        values_dict = {f'{self.study_name}.year_start': self.year_start,
                       ...
                       f'{self.study_name}.{renewable_name}.technologies_list': self.technologies_list,
                       f'{self.study_name}.{renewable_name}.RenewableSimpleTechno.margin': self.margin,

                       f'{self.study_name}.{renewable_name}.transport_cost': self.transport,
                       f'{self.study_name}.{renewable_name}.transport_margin': self.margin,
        ...
        if self.main_study:
            ...
            if self.one_invest_discipline:
                ...
                for techno in self.technologies_list:
                    ...
                    values_dict[f'{self.study_name}.{renewable_name}.{techno}.invest_level'] = invest_level_techno
            else:
                values_dict[f'{self.study_name}.{renewable_name}.invest_level'] = self.invest_level
        else:

...
class ProcessBuilder(BaseProcessBuilder):
    ...
    def get_builders(self):
        ...
        builder_list.extend(self.create_builder_list(
            ...
            ns_dict={
                "ns_ghg_emissions": f"{self.ee.study_name}.{GHGemissionsDiscipline.name}"
            })
        )
        ...
        builders_list_out = [coupling_builder]
        # ---------------------------------------------
        ...
        builders_list_out.append(design_var_builder)
        ...
        builders_list_out.append(fmanager_builder)

...
class Study(StudyManager):
    ...
    def setup_usecase(self, study_folder_path=None):
        ...
        values_dict.update({
            ...
            f"{self.study_name}.{self.coupling_name}.{GHGemissionsDiscipline.name}.{GlossaryEnergy.ResidentialEnergyConsumptionDfValue}": agriculture_land_use_emissions,

            f"{self.study_name}.{self.coupling_name}.{GHGemissionsDiscipline.name}.{GlossaryEnergy.SectorServices}.{GlossaryEnergy.SectionEnergyConsumptionDfValue}": df_zeros_sections,
            f"{self.study_name}.{self.coupling_name}.{GHGemissionsDiscipline.name}.{GlossaryEnergy.SectorServices}.{GlossaryEnergy.SectionNonEnergyEmissionGdpDfValue}": df_zeros_sections,
            f"{self.study_name}.{self.coupling_name}.{GHGemissionsDiscipline.name}.{GlossaryEnergy.SectorServices}.{GlossaryEnergy.SectionGdpDfValue}": df_zeros_sections,

            f"{self.study_name}.{self.coupling_name}.{GHGemissionsDiscipline.name}.{GlossaryEnergy.SectorIndustry}.{GlossaryEnergy.SectionEnergyConsumptionDfValue}": df_zeros_sections,
            f"{self.study_name}.{self.coupling_name}.{GHGemissionsDiscipline.name}.{GlossaryEnergy.SectorIndustry}.{GlossaryEnergy.SectionNonEnergyEmissionGdpDfValue}": df_zeros_sections,
            f"{self.study_name}.{self.coupling_name}.{GHGemissionsDiscipline.name}.{GlossaryEnergy.SectorIndustry}.{GlossaryEnergy.SectionGdpDfValue}": df_zeros_sections,
        })
        return values_dict

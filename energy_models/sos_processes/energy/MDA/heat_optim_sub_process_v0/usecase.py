...
from energy_models.sos_processes.energy.MDA.heat_process_v0_mda.usecase import Study as datacase_energy
...
class Study(ClimateEconomicsStudyManager):
    ...
    def __init__(self, year_start=2020, year_end=2100, time_step=1, bspline=True, run_usecase=False,
                 ...
                 invest_discipline=INVEST_DISCIPLINE_OPTIONS[
                     1], techno_dict=DEFAULT_TECHNO_DICT,
                 process_level='val'): #, agri_techno_list=AGRI_MIX_TECHNOLOGIES_LIST_FOR_OPT

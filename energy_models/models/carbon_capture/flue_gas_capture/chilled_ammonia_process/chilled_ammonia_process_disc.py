...
class ChilledAmmoniaProcessDiscipline(CCTechnoDiscipline):
    ...
    _ontology_data = {
        'label': 'Chilled Amonia Process Model',
        'type': 'Research',
    ...
    heat_duty = 2500  # SAEECCT - MJ/tCO2  page no:9, # https://sci-hub.et-fine.com/10.1016/j.ijggc.2019.03.006
    elec_demand_capture = 400  # SAEECCT - MJ/tCO2 page no:9, # https://sci-hub.et-fine.com/10.1016/j.ijggc.2019.03.006
    ...
    techno_infos_dict_default = {'lifetime': lifetime,
                                 ...
                                 # SAEECCT - 1390 M$
                                 'Capex_init': 1390000000 / (c02_capacity_year * carbon_capture_efficiency),
                                 ...
                                 'carbon_capture_efficiency': carbon_capture_efficiency,  # SAEECCT - USC CAP

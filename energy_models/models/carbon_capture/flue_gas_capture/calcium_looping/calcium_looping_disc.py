...
class CalciumLoopingDiscipline(CCTechnoDiscipline):
    ...
    heat_duty = 18  # SAEECCT - MJ/tCO2 page no:9, # https://sci-hub.et-fine.com/10.1016/j.ijggc.2019.03.006
    elec_demand_capture = 338  # SAEECCT - MJ/tCO2 page no:9, # https://sci-hub.et-fine.com/10.1016/j.ijggc.2019.03.006 
    ...
    techno_infos_dict_default = {'lifetime': lifetime,
                                 ...
                                 'carbon_capture_efficiency': carbon_capture_efficiency,  # SAEECCT - USC Cal
    ...
    def init_execution(self):
        ...
        self.techno_model = CalciumLooping(self.techno_name)

...
from energy_models.models.carbon_capture.flue_gas_capture.piperazine_process.piperazine_process import (
    PiperazineProcess,
)


class PiperazineProcessDiscipline(CCTechnoDiscipline):
    ...
    techno_infos_dict_default = {'capacity_factor': 0.85,  # SAEECCT - Coal capacity factor
                                 ...
                                 # SAEECCT - 1342 M$
                                 'Capex_init': 1342000000 / (c02_capacity_year * carbon_capture_efficiency),
                                 ...
                                 'carbon_capture_efficiency': carbon_capture_efficiency,  # SAEECCT - USC PZ
    ...
    def init_execution(self):
        self.model = PiperazineProcess(self.techno_name)

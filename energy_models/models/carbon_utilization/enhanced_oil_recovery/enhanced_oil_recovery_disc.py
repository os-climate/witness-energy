...
from energy_models.models.carbon_utilization.enhanced_oil_recovery.enhanced_oil_recovery import EnhancedOR


class EnhancedOilRecoveryDiscipline(CUTechnoDiscipline):
    """**EnergyModelsDiscipline** is the :class:`~gems.core.discipline.MDODiscipline`
    implementing the computation of Energy Models outputs."""

    # ontology information
    _ontology_data = {
        'label': 'Enhanced Oil Recovery Model',
        'type': 'Research',
    ...
    def init_execution(self):
        ...
        self.techno_model = EnhancedOR(self.techno_name)

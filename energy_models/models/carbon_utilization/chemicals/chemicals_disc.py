...
from energy_models.models.carbon_utilization.chemicals.chemicals import Chemicals


class ChemicalsDiscipline(CUTechnoDiscipline):
    """**EnergyModelsDiscipline** is the :class:`~gems.core.discipline.MDODiscipline`
    implementing the computation of Energy Models outputs."""

    # ontology information
    _ontology_data = {
        'label': 'Chemicals Model',
        'type': 'Research',
    ...
    def init_execution(self):
        ...
        self.techno_model = Chemicals(self.techno_name)

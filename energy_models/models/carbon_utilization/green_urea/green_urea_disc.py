...
from energy_models.models.carbon_utilization.green_urea.green_urea import GreenUrea


class GreenUreaDiscipline(CUTechnoDiscipline):
    """**EnergyModelsDiscipline** is the :class:`~gems.core.discipline.MDODiscipline`
    implementing the computation of Energy Models outputs."""

    # ontology information
    _ontology_data = {
        'label': 'Green Urea Model',
        'type': 'Research',
    ...
    def init_execution(self):
        ...
        self.techno_model = GreenUrea(self.techno_name)

...
from energy_models.models.carbon_utilization.building_material.building_material import BuildingM


class BuildingMaterialDiscipline(CUTechnoDiscipline):
    """**EnergyModelsDiscipline** is the :class:`~gems.core.discipline.MDODiscipline`
    implementing the computation of Energy Models outputs."""

    # ontology information
    _ontology_data = {
        'label': 'Building Material Model',
        'type': 'Research',
    ...
    def init_execution(self):
        ...
        self.techno_model = BuildingM(self.techno_name)

...
from energy_models.models.carbon_utilization.fuel_production.algae_cultivation.algae_cultivation import AlgaeCultivation
...
class AlgaeCultivationDiscipline(CUTechnoDiscipline):
    ...
    techno_name = 'fuel_production.AlgaeCultivation'
    ...
    techno_infos_dict_default = {'maturity': 0,
                                ...
                                'elec_demand_unit': 'kWh/kg',
                                 ...
                                 'calorific_value': 7.0, #https://www.aimspress.com/fileOther/PDF/energy/energy-04-00347.pdf
    ...
    # Total production = 9 100 million litres
    #density = 0.880 kg/liter
    # 7 is calorific value in Kwh/kg

    # 1000000
    initial_utilization = 9100 * 1000000 * 0.880 * 7.0 * 1e-9 # Twh   # https://www.iea.org/reports/renewables-2022/transport-biofuels
    ...
    DESC_IN = {'techno_infos_dict': {'type': 'dict',
               ...
               'initial_production': {'type': 'float', 'unit': 'Twh', 'default': initial_utilization},

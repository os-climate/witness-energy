...
from energy_models.models.carbon_utilization.polymers.polymers import Polymers


class PolymersDiscipline(CUTechnoDiscipline):
    """**EnergyModelsDiscipline** is the :class:`~gems.core.discipline.MDODiscipline`
    implementing the computation of Energy Models outputs."""

    # ontology information
    _ontology_data = {
        'label': 'Polymers Model',
        'type': 'Research',
    ...
    def init_execution(self):
        ...
        self.techno_model = Polymers(self.techno_name)

...
class FoodBeverageAppl(CUTechno):
    ...
    def compute_consumption_and_production(self):
        ...
        self.consumption_detailed[f'{BiomassDry.name} (TWh)'] = self.production_detailed[f'{CUTechno.energy_name} ({self.product_energy_unit})'] / \

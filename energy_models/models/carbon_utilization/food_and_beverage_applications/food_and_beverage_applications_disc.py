...
from energy_models.models.carbon_utilization.food_and_beverage_applications.food_and_beverage_applications import FoodBeverageAppl


class FoodBeverageApplDiscipline(CUTechnoDiscipline):
    """**EnergyModelsDiscipline** is the :class:`~gems.core.discipline.MDODiscipline`
    implementing the computation of Energy Models outputs."""

    # ontology information
    _ontology_data = {
        'label': 'Food Beverage Application Model',
        'type': 'Research',
    ...
    def init_execution(self):
        ...
        self.techno_model = FoodBeverageAppl(self.techno_name)

...
class HydrogenBoilerLowHeatDiscipline(LowHeatTechnoDiscipline):
    ...
    techno_name = 'HydrogenBoilerLowHeat'
    ...
    techno_infos_dict_default = {
        ...
        'hydrogen_demand': 1.30,   #https://www.google.com/search?q=hydrogen+boiler,+hydrogen+required+to+produce+1kwh+of+heat&source=lmns&bih=585&biw=925&rlz=1C1UEAD_enIN1000IN1000&hl=en&sa=X&ved=2ahUKEwiE14bTn5OCAxWN2jgGHfZqCYYQ_AUoAHoECAEQAA

...
class HydrogenBoilerHighHeatDiscipline(HighHeatTechnoDiscipline):
    ...
    techno_infos_dict_default = {
        ...
        'methane_demand': 1.055556,    # 3.8 MJ = 1.055556 KWh    #https://livinglaudatosi.com/hydrogen-vs-heat-pumps-educational-resource/
    ...
    # production in 2021: 57200000/3 = 19066666 million gallons  #https://www.sciencedirect.com/science/article/pii/S0360319914031383
    # in TWh
    ...
    invest_before_year_start = pd.DataFrame(
        {'past years': np.arange(-construction_delay, 0), 'invest': 250/(16 * 8760) * np.array([0, 19066666])})

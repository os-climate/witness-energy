...
#         'calorific_value']
    ...
    invest_before_year_start = pd.DataFrame(
        {'past years': np.arange(-construction_delay, 0), GlossaryCore.InvestValue: [1.135081, 1.135081, 1.135081]})
...
#
    ...
    def get_production_chart(self):
        ...
        new_chart = TwoAxesInstanciatedChart(GlossaryCore.Years, f'Production of Managed wood (TWh)',
                                             [year_start, year_end], [
                                                 minimum, maximum],
    ...
    def get_chart_price_in_dollar_kg(self):
        ...
        new_chart = TwoAxesInstanciatedChart(GlossaryCore.Years, f'Production of Managed wood ($/t)',
    ...
    def get_chart_price_in_dollar_Mwh(self):
        ...
        max2 = max(price_mix_df[name_wood].values.tolist())
        maximum = max(max1, max2) * 1.2
        new_chart = TwoAxesInstanciatedChart(GlossaryCore.Years, f'Production of Managed wood ($/MWh)',
                                             [year_start, year_end], [0.0, maximum], chart_name=chart_name)

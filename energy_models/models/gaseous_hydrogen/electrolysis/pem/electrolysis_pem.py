...
class ElectrolysisPEM(GaseousHydrogenTechno):
    ...
    def compute_other_primary_energy_costs(self):
        ...
        self.cost_details[f'{self.PLATINUM_RESOURCE_NAME}_needs'] = self.get_theoretical_platinum_fuel_needs()
    ...
    def grad_price_vs_resources_price(self):
        ...
        platinum_needs = self.get_theoretical_platinum_fuel_needs()
        return {
    ...
    def get_theoretical_platinum_fuel_needs(self):
        """

...
class HefaDeoxygenation(HydrotreatedOilFuelTechno):
    ...
    def compute_byproducts_production(self):
        ...
        self.outputs[f'{GlossaryEnergy.TechnoProductionWithoutRatioValue}:{Water.name} ({GlossaryEnergy.mass_unit})'] = water_prod_factor * self.outputs[f'{GlossaryEnergy.TechnoProductionWithoutRatioValue}:'
